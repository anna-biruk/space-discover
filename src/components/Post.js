const Post = () => {
    return (
        <div className="post">
            <h2 className="post__title">Embark on a space journey</h2>
            <p className="post__text">
                ...
                is ready to help you realize this dream. We offer a unique experience
                that will allow you to go on a space journey and see all the secrets
                of the universe. We guarantee that every moment in space will be filled
                with incredible impressions, excitement and new discoveries. Our team of
                professionals takes care of your safety and comfort so that you can fully
